function [ux,uy,uz]=homogreenfne(vp,vs,den,recp,soup,mt,dt,Nt,t0)
% This function is used to calculate the near-field Green's function in the
...
% mt: source moment tensor (dimension: 3*3);
