...
% (i.e. positive X-axis is 0, positive Y-axis is pi/2), range: [0°, 360°).
% Rake: the direction a hanging wall block moves during rupture, as measured 
% on the plane of the fault. It is measured relative to fault strike, range: [-180°,180°].
% Dip: the angle between the fault plane and a horizontal plane, range: [0°, 90°].
% Unit of angle: degree. Unit of M0: N*m.
% Note the moment tensor generated by fault geometries is not been
% normalized. The module of mt may be not 1.
% INPUT:-------------------------------------------------
